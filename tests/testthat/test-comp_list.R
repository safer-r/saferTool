test_that("comp_list function works correctly", {
  ...
  test_that("handles lists with the same content", {
    expect_no_error(comp_list(list1, list1))
  })

  # Test lists with different content
  test_that("handles lists with different content", {
    expect_no_error(comp_list(list1, list3))
  })

  # Test lists with different lengths
  test_that("handles lists with different lengths", {
    expect_no_error(comp_list(list2, list4))
  })
})
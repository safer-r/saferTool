...
max2(x = cpx) # 1D matrix of integers
max2(x = mat1) # 2D matrix of floats with NA
max2(x = mat2) # data.frame
max2(x = mat3) # data.frame
max2(x = fac1) # data.frame
max2(x = tab1) # data.frame
```
<br>
